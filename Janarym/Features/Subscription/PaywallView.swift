                    ...
                    VStack(spacing: 12) {
                        ...
                        PlanCard(
                            ...
                            features: kk ? [
                                ...
                                "Барлық режимдер (5 режим)",
                                "OpenAI nova дауысы",
                                "Проактивті бақылау (SceneWatcher)",
                                "Есте сақтау жүйесі (жад)",
                                "Кеңейтілген контекст (10 хабар)"
                            ] : [
                                "Безлимитные запросы",
                                "Высококачественное AI-зрение (512px)",
                                "Все режимы (5 режимов)",
                                "Голос OpenAI nova",
                                "Проактивный мониторинг (SceneWatcher)",
                                "Система памяти",
                                "Расширенный контекст (10 сообщений)"
                            ]
                        ) {
                            selectedPlan = .vip
                        }
